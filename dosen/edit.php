    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <select class="form-select" name="fakultas">
                ...
                <option value="FATEK"<?php echo ($data['fakultas'] == 'FATEK') ? "selected" : "";  ?> >Fakultas Teknik</option>
                <option value="FTI" <?php echo ($data['fakultas'] == 'FTI') ? "selected" : "";  ?> >Fakultas Teknologi dan Infomasi</option>
                <option value="FKM" <?php echo ($data['fakultas'] == 'FKM') ? "selected" : "";  ?> >Fakultas Kesehatan Masyarakat</option>
                <option value="FEKON" <?php echo ($data['fakultas'] == 'FEKON') ? "selected" : "";  ?> >Fakultas Ekonomi dan Bisnis</option>
            </select>
        </div>
    </div>
    <div class="mb-3 row">
